    ...
    <div class="container">
        ...
        <div class="col-12">
            <form ref="form">
                ...
                <module-content v-on:save-callback="getContent" ref="content"></module-content></module-content>
                <div class="form-group pt-3" >
                    <button
...
export default {
    ...
    methods: {
        openModal(){
            this.$refs.content.openModal(this.module_id)
        ...
        save() {
            ...
            axios.post(`/api/module/store`, formData).then((res) => {
                Swal.fire({
                    icon: "success",
                    title: "Berhasil",
